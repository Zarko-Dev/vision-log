    ...
    return (
        <div className="w-full h-full relative p-6">
            <div className="absolute top-24 md:top-6 left-6 z-20 pointer-events-none">
                <h1 className="text-3xl font-bold text-neutral-900 dark:text-white mb-2">Inventário</h1>
                <p className="text-neutral-500 dark:text-gray-400">Conteúdo do Inventário em desenvolvimento</p>
            </div>
